...
// Project properties
group = " com.github.epicnose.friendlypenetration"
version = "0.1.3.0"
...
java {
  ...
  withSourcesJar()
//  withJavadocJar() // TODO: waiting fix
}
...
dependencies {
  ...
  api(rfg.deobf(project.files("libs/LOTRMod+v36.15 chs.jar")))
}
